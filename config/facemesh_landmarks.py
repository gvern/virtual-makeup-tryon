# Define MediaPipe FaceMesh connections (complete list)

# FORMAT TO BE CHANGED 

FACEMESH_BLUSH_LEFT = frozenset([
    (50, 205),
    (205, 187),
    (187, 123),
    (123, 117),
...
FACEMESH_BLUSH_RIGHT = frozenset([
    (280, 330),
    (330, 347),
    (347, 346),
    (346, 352),
...
FACEMESH_EYESHADOW_LEFT = frozenset([
    (226, 247),
    (247, 30),
    (30, 29),
    (29, 27),
...
FACEMESH_EYESHADOW_RIGHT = frozenset([
    (463, 414),
    (414, 286),
    (286, 258),
    (258, 257),
...
# Complete FACEMESH_TESSELATION as provided
