...
class MakeupApp:
        ...
        if file_path:
            try:
                ...
                if self.makeup_tryon.lipstick_color is None:
                    logging.error("Lipstick color extraction failed.")
                    raise ValueError("Lipstick color extraction failed.")
                ...
                logging.info(f"Lipstick Color Displayed: {color_hex}")
    ...
    def start_makeup(self):
        ...
        self.makeup_tryon.thread = threading.Thread(
        ...
        self.makeup_tryon.thread.start()
    ...
    def on_closing(self):
        ...
        if self.makeup_tryon.running:
            self.makeup_tryon.stop_webcam()
            if self.makeup_tryon.thread and self.makeup_tryon.thread.is_alive():
                self.makeup_tryon.thread.join()
